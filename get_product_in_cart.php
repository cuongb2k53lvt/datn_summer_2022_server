<?php
    ...
    products_fashionshop.brand_id = brand_fashionshop.brand_id INNER JOIN cart_fashionshop ON 
    products_fashionshop.product_id = cart_fashionshop.product_id WHERE cart_fashionshop.user_id = '$user_id'";
