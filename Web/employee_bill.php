<?php
    ...
    $bill_html = '';
    $get_employee_bill = "SELECT * FROM bill_fashionshop INNER JOIN user_fashionshop ON bill_fashionshop.user_id = user_fashionshop.user_id WHERE employee = '$employee_account'";
