<?php
    ...
    if($type == 'Tất cả'){
        ...
        products_fashionshop.brand_id = brand_fashionshop.brand_id WHERE products_fashionshop.brand_id = '$brand_id' AND products_fashionshop.status = 'Còn hàng'  
        ORDER BY products_fashionshop.price ".$value;
    }else{
        $get_all_product = "SELECT * FROM products_fashionshop INNER JOIN clothes_type_fashionshop ON 
        products_fashionshop.type_id = clothes_type_fashionshop.type_id INNER JOIN brand_fashionshop ON 
        products_fashionshop.brand_id = brand_fashionshop.brand_id WHERE products_fashionshop.brand_id = '$brand_id' AND  clothes_type_fashionshop.type = '$type' AND products_fashionshop.status = 'Còn hàng' 
        ORDER BY products_fashionshop.price ".$value;
    }
