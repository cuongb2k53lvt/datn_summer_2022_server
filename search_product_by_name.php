<?php
    ...
    products_fashionshop.brand_id = brand_fashionshop.brand_id WHERE products_fashionshop.product_name LIKE '%$search_text%' AND products_fashionshop.status = 'Còn hàng'";
